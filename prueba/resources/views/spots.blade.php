...
<html lang="en">
    ...
    <body>
        ...
        <form class="card mx-auto col-6" method="POST" action="{{route("nuevoSpot")}}">
            @csrf
            <p>Titulo:</p>
            ...
            <p>Coordenadas:</p>
            <div class="row mx-1">
                <input id="latitud" class="form-control col-3" name="Titulo" type="text"/>
                <input id="longitud" class="form-control col-3" name="Titulo" type="text"/>
            </div>
            <br>
        ...
        <script>
            var mymap = L.map('mapid').setView([43.314, -1.990], 13);
